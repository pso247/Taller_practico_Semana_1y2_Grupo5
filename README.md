...
![Evidencias_GitHub](./Evidencias_Github/img/Imagen1.png)

### git init: Inicializa el repositorio local.
![Evidencias_GitHub](./Evidencias_Github/img/Imagen2.png)

### git status: Muestra el estado actual.

![Evidencias_GitHub](./Evidencias_Github/img/Imagen3.png)
...
![Evidencias_GitHub](./Evidencias_Github/img/Imagen4.png)
